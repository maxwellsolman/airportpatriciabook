...
export const PRODUCT = {
  name: "Patricia's Insider Travel Playbook",
...
// Teaser sections only. We intentionally do NOT list the individual plays
...
export const FAQ = [
  { q: "What exactly do I get?", a: "A 20-page premium PDF guide with all ten insider plays written in Patricia's voice, plus a one-page Pre-Flight Checklist you can save to your phone. You get it instantly after checkout." },
  ...
  { q: "Who is this for?", a: "Anyone who flies, from once a year to once a week. If you book travel, you're almost certainly leaving money on the table that these plays help you keep." },
  { q: "Will these plays really save me money?", a: "Most travelers make back the $9.99 on their very next trip with a single play. Play number one alone has caught hundreds of dollars in price drops people never knew existed." },
  { q: "Can I get a refund?", a: "Yes, we offer a 30-day satisfaction guarantee. See the guarantee terms below for how it works." },
];

export const TESTIMONIALS = [
  { name: "Marcus T.", tag: "Flies 6x a year", text: "Used play #1 on a Cancun trip and the price dropped $214 a week after I booked. I got it back. This paid for itself a hundred times over.", stars: 5 },
